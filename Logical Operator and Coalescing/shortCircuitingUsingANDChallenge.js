...
function authenticationCheck(passCode){
    ...
    // swissBankPassCodesArr.forEach((pass)=>{
    //     passCode === pass && console.log(`Your balance is ${accountBalanceUsd}`)
    // })


    // By using reduce method

    swissBankPassCodesArr.includes(passCode) && console.log(`Your balance is ${accountBalanceUsd}`)
/*
Challenge:
